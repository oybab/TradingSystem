...
{
    public sealed class KeyboardLittleFullViewModel : ViewModelBase
    {
        private Action<string> Input;
        private Action<string> Command;

        internal KeyboardLittleFullViewModel(Action<string> Input, Action<string> Command)
        {
            this.Input = Input;
        ...
        /// 字符
        /// </summary>
        private RelayCommand _charCommand;
        public ICommand CharCommand
        {
            get
            {
                ...
                {
                    _charCommand = new RelayCommand(param =>
                    {
