...
namespace Oybab.Res.Reports
{
    public sealed class Print
    {
        ...
        public void PrintBarcode(List<ProductLabel> models, int sizeMode, int langIndex)
        {
            ...
            {
                report = new ProductLabelMedium();
            }
            else if (sizeMode == 1) //3cmX2cm
            {
                report = new ProductLabelSmall();
            }
            ...
            {
                reportModel.IsEAN13Generator = true;
            }



            ReportPrinter rp = new ReportPrinter();
            rp.PrintReport(report, reportModel, null);
