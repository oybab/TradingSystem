...
{
    public sealed partial class AdminSaleProductReport : DevExpress.XtraReports.UI.XtraReport
    {
        private double MaxPrice = 0;
        private string PriceSymbol = "￥";
        public AdminSaleProductReport(double maxPrice, string PriceSymbol)
        {
            InitializeComponent();
        ...
        {
            RecordProducts product = GetCurrentRow() as RecordProducts;
