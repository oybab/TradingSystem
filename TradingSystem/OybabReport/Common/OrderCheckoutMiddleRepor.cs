...
{
    public sealed partial class OrderCheckoutMiddleRepor : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public OrderCheckoutMiddleRepor(Order order, List<Product> productList, Printer printer, string PriceSymbol, long Lang = -1)
        {
            this.Order = order;
            ...
            FixMoneyFormat(new List<XRBinding>() {
                ...
                xrTableCell81.DataBindings.FirstOrDefault()
            });
