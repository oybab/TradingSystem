...
{
    public sealed partial class ImportMiddleReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public ImportMiddleReport(Import import, List<Product> productList, Printer printer, string PriceSymbol, long Lang = -1)
        {
            this.import = import;
