...
{
    public sealed partial class TakeoutCheckoutReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public TakeoutCheckoutReport(Takeout order, List<Product> productList, Printer printer, string PriceSymbol, long Lang = -1)
        {
            this.Takeout = order;
