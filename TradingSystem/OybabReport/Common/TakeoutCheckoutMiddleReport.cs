...
{
    public sealed partial class TakeoutCheckoutMiddleReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public TakeoutCheckoutMiddleReport(Takeout order, List<Product> productList, Printer printer, string PriceSymbol, long Lang = -1)
        {
            this.Takeout = order;
