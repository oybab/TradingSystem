...
{
    internal sealed partial class RegCountWindow : KryptonForm
    {
        private bool IsModalMode = false;
        public RegCountWindow(bool IsModalMode)
        {
            ...
            this.Text = Resources.GetRes().GetString("RegisterCount");
            ...
            this.Icon = new Icon(asm.GetManifestResourceStream(@"Oybab.Res.Resources.Images.PC.RegCount.ico"));
            ...
            if (string.IsNullOrWhiteSpace(Resources.GetRes().RegCountRequestCode))
            {
                ...
                Task.Factory.StartNew(() =>
                {
                    try
                    {
                        ...
                        bool result = OperatesService.GetOperates().ServiceRequestCountCode();
                        ...
                        this.BeginInvoke(new Action(() =>
                        {
                            if (result)
                            {
                                krplRequestCodeValue.Text = Resources.GetRes().RegCountRequestCode;
                            }
                            else
                            {
        ...
        private void krpbReg_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Task.Factory.StartNew(() =>
                {
                    try
                    {
                        bool result = OperatesService.GetOperates().ServiceRegCount(krptRegCode.Text.Trim());
