...
{
    internal sealed partial class PriceChangeWindow : KryptonForm
    {
        private string Mark = "+";
        ...
        public PriceChangeWindow(string mark, double TotalPrice, double paidPrice, bool IsActualPrice = false)
        {
            InitializeComponent();
            ...
            if (IsActualPrice)
                krplTotalPrice.Text = Resources.GetRes().GetString("ActualPrice");
            else
